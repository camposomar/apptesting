    ...
    <div style="padding-top:25px; overflow:hidden;">
    	<div style="width:230px;float:left;background-image:url(images/dedicated_features.png); height:282px; margin-left:10px;"></div>
      		<div id="slider_contenedor_fijo" style="width:690px; height:470px; float:left; overflow:hidden; margin-left:5px;">
                <div style="height:470px; position:relative; width:<?=230*$tb_page_dedicated_package->math("COUNT","domain_id=$domain_id_instant AND type='Server-Personalized'"); ?>px; left:0px;" id="home_slide_pack">
                 
                 <? 
				 
				  	$list_page_dedicated_package=$tb_page_dedicated_package->select("processor,processor_icon,bandwidth,bandwidth_max,disk_space,disk_space_max,memory,memory_max,ethernetport,ethernetport_max,monthly_price,price_centos_cpanel,link_tobuy,price_windows,price_windows_plesk","domain_id=$domain_id_instant AND type='Server-Personalized' Order by monthly_price ASC");
					...
					do{  ?>
					 <div style="width:230px;float:left;background-image:url(images/dedicated_background_package.png);height:470px;">
                        ...
                        <div style="height:4px; margin-left:3px; height:32px;margin-right:11px;border-bottom:solid 1px #CCC; margin-bottom:4px;background-color:#FAFAFA;padding-left:4px; padding-top:16px; 
font-size:12px;" onmouseover="style.backgroundColor='#E8E8E8';style.cursor='pointer';" onmouseout="style.backgroundColor='#FAFAFA';"><strong style="color:#F60;">mín.</strong> 
<?=$row_page_dedicated_package['ethernetport'] ?>MB/s. <strong style="color:#F60;">máx.</strong> <?=$row_page_dedicated_package['ethernetport_max'] ?>MB/s.</div>
    ...
    <div style="margin:0 auto 0 auto;width:920px; height:45px;margin-top:10px;"> 
    		<div style="float:right; padding-right:10px;">
                ...
                <div style="height:36px; width:40px;float:left;padding-top:5px;"><input id="buttonMovePageLeft" type="button" value=" " style="background-image:url(images/icore_next_btn_orange_left.png);background-color:#FFF; height:32px; width:39px; cursor:pointer; border:none;"  onclick="javascript:movepack('leftToright','<?=230*$tb_page_dedicated_package->math("COUNT","domain_id=$domain_id_instant AND type='Server-Personalized'"); ?>');"/></div>
                <div style="height:36px; width:40px;float:left;padding-top:5px;"><input id="buttonMovePageRight" type="button" value=" " style="background-image:url(images/icore_next_btn_orange_right.png); background-color:#FFF;height:32px; width:39px;cursor:pointer; border:none;" onclick="javascript:movepack('rightToleft','<?=230*$tb_page_dedicated_package->math("COUNT","domain_id=$domain_id_instant AND type='Server-Personalized'"); ?>');"/></div>
            </div>
    </div>
    <div style="margin:0 auto 0 auto;width:950px; height:29px; background-image:url(images/home_slider_shadow.png);"></div>
  	<!-- Inicia DIV -->
