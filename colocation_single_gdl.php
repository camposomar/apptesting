...
<div style="overflow:hidden;">
    ...
    <div style="padding:5px;font-size:14px; font-weight:bold;">NOTA: El centro de datos de Guadalajara, Jalisco, México estará disponible a partir del 31 de Octubre de 2012.</div>
    <div><br />Selecciona un centro de datos: <a href="<?php if($_SESSION['country']=='venezuela' || $_SESSION['country']=='argentina'){echo $_SESSION['country']; } ?>/colocacion/servidorindividual/" style="padding:10px; height:15px;">Orlando, FL, USA</a> <a href="<?php if($_SESSION['country']=='venezuela' || $_SESSION['country']=='argentina'){echo $_SESSION['country']; } ?>/colocacion/servidorindividual/gdl/" style="padding:10px; height:15px; background-color:#666; color:white;">Guadalajara, Jal, MX</a></div>
    <div style="padding-top:25px; overflow:hidden;">
      		...
      		<div id="slider_contenedor_fijo" style="width:690px; height:470px; float:left; overflow:hidden; margin-left:5px;">
                <div style="height:470px; position:relative; width:<?=230*$tb_page_colocation->math("COUNT","domain_id=$domain_id_instant AND type='Colocation-Single' AND dc=1"); ?>px; left:0px;" id="home_slide_pack">
                 
                 <? 
				 
				  	$list_page_colocation=$tb_page_colocation->select("name,type,mbps,volts,ips,price_monthly,setup_local,local","domain_id=$domain_id_instant AND type='Colocation-Single' AND dc=1 ORDER by price_monthly ASC");
					...
					do{  ?>
					 <div style="width:230px;float:left;background-image:url(images/dedicated_background_package.png);height:470px;">
                        ...
                        <div style="height:4px; margin-left:3px; height:75px;margin-right:11px;border-bottom:solid 1px #F5F5F5; text-align:right;padding-top:3px; padding-right:3px;"  onmouseover="style.backgroundColor='#E8E8E8';style.cursor='pointer';" onmouseout="style.backgroundColor='#FFF';">
                            ...
                            <div style="font-size:10px; color:#666;"> Si usted manda su servidor hasta nuestro Centro de Datos en Guadalajara, Jalisco, MX.</div>
                       	</div>
				    </div>
