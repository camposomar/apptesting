...
<div style="overflow:hidden; padding-bottom:45px;">
	<div style="margin:0 auto 0 auto;border:none;width:950px;margin-top:3px; overflow:hidden; padding-bottom:40px;">
    	<? include("domain_slider_dynamic.php");?>
...
?>
	<form method="get" action="<?=$_SESSION['country'].$_SESSION['page_seccion']; ?>" id="form_tld<?=str_replace('-','_',$k);?>_<?=str_replace(".",'_',$fe_dominio['tld']);?>" name="form_tld_<?=str_replace('-','_',$k);?>_<?=str_replace(".",'_',$fe_dominio['tld']);?>">	 
	...
	<div style="float:left;width:150px;">
		<img src="images/btn_order_lila.png" alt="" style="cursor:pointer; border:none;"  onclick="document.form_tld_<?=str_replace('-','_',$k);?>_<?=str_replace(".",'_',$fe_dominio['tld']);?>.submit();"/>
	</div>
	</div>
 </form>    
<?
