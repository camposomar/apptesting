...
<? 
$list_package=$tb_core_packages->select("package_id,name,price_monthly,price_quarterly,module,price_semiannual,price_yearly,price_2yearly,price_3yearly","company_id='$_SESSION[core_company_id]' AND type='reseller' AND module='cpanel' Order by price_monthly ASC");
$row_package=mysql_fetch_assoc($list_package);
?>
<div style="overflow:hidden; ">
    
        <div style="color:#333; font-size:26px; font-weight:900px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-shadow: 0 1px 0 #EAEAEA; margin-top:10px;">Web Hosting Reseller con WHM</div>
        <div style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:13px; color:#333;text-shadow: 0 1px 0 #F9F9F9; margin-top:15px; margin-bottom:25px; line-height:20px;"> ¡Comienza a Revender! con nuestros paquetes de revendedor tienes la libertad de crear tus propios paquetes, venderlos al precio que quieras y, a cada cliente tuyo darle su propio usuario y contraseña para que ellos tengan su propio cPanel.</div>
                	...
                	<div style="width:310px;float:left;height:470px;">
                    	<div style="height:465px; margin-left:5px; margin-right:5px; border:solid 1px #ECECEC;" class="redondeo10px">
                            ...
                            <div style="border-bottom:solid 1px #F6F6F6; margin-left:5px; margin-right:5px;margin-bottom:7px;">
                                ...
                                <div style="color:#06C; font-size:14px;"><?=$tb_page_packages->obtenerDato("domain_hosted","package_id_core=".$row_package['package_id']);?></div>
                            </div>
                            ...
                            <div><input type="hidden" name="service_type" value="linux_reseller" /></div>
