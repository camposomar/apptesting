<div style="height:450px;  background-image:url(images/background_domains.png); background-repeat:no-repeat;border:solid 1px #FFF; margin-bottom:25px;">
        <div style="font-size:22px;  margin-left:70px; margin-top:15px; margin-bottom:20px; text-align:left; font-weight:500; color:#FFF">Registra todos tus dominios .mx aquí</div>
        <div style="border-bottom:solid 1px #E8E8E8; margin-left:30px; margin-right:50px; overflow:hidden; margin-top:40px; padding-bottom:10px;">
            ...
            <div style="float:left;width:400px;">
            	<div style="font-size:22px; color:#069;"></div>
        ...
        <div style="margin-left:30px; margin-right:50px; overflow:hidden; margin-top:15px;">
            <form method="post" action="<?=$_SESSION['country'] ?>/dominios/registrar/mx/#list_domains" id="form_slider_domain" name="form_slider_domain">
            <div style="width:375px; float:left; overflow:hidden;border-left:solid 1px #F0F0F0; ">
                <textarea name="domains_names" id="domains_names" style="width:330px;font-size:16px;" rows="4"></textarea>
            </div>
            <div style="width:255px;float:left; padding-left:10px; overflow:hidden;height:120px;">
            <? 
			/*
            ...
            */
			?>
            	<div style="font-size:35px;color:#666;line-height:78px;">.mx</div>
            </div>	
            ...
            <div style="visibility:hidden;"><input type="checkbox" value="mx" id="mx" name="mx" checked=""></div>
            </form>	
       </div>    
