...
<? 
$list_package=$tb_core_packages->select("package_id,name,price_monthly,price_quarterly,module,price_semiannual,price_yearly,price_2yearly,price_3yearly","company_id='$_SESSION[core_company_id]' AND type='reseller' AND module='plesk' Order by price_monthly ASC");
$row_package=mysql_fetch_assoc($list_package);
?>
<div style="overflow:hidden; ">
    
        <div style="color:#333; font-size:26px; font-weight:900px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-shadow: 0 1px 0 #EAEAEA; margin-top:10px;">Web Hosting Reseller con Plesk</div>
        <div style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:13px; color:#333;text-shadow: 0 1px 0 #F9F9F9; margin-top:15px; margin-bottom:25px; line-height:20px;"> Plesk es un panel de Control que hemos instalado sobre servidores con sistema operativo Windows, por lo tanto tus aplicaciones o las de tus clientes desarrolladas para ésta tecnología, aquí se ejecutarán sin ningún problema. Cuando tienes un Plan tipo Reseller, tu puedes hacer tus propios paquetes y venderlos al precio que quieras a tu cliente.</div>
                ...
                ?>
                	<div style="width:310px;float:left;height:470px;">
                    	<div style="height:465px; margin-left:5px; margin-right:5px; border:solid 1px #ECECEC;" class="redondeo10px">
                            ...
                            <div style="border-bottom:solid 1px #F6F6F6; margin-left:5px; margin-right:5px;margin-bottom:7px;">
                            	<div style="color:#000; font-weight:700;">Dominios Soportados:</div>
                            ...
                            <div style="border-bottom:solid 1px #F6F6F6; margin-left:5px; margin-right:5px;margin-bottom:7px;">
                            	<div style="color:#000; font-weight:700;">Cuenta de Reseller de Dominios:</div>
                                <div style="color:#06C; font-size:14px;">al solicitarla, es Gratis</div>
                            </div>
                            ...
                            <div><input type="hidden" name="service_type" value="windows_reseller" /></div>
	...
	<!-- Inicia DIV -->
     <? 
		...
		include("modules_service/module_plesk_reseller.php");
