...
?>
<div style="height:450px; background-image:url(images/vps_windows_slider.png); background-repeat:no-repeat;">
			<div style="width:410px; height:180px; padding-top:150px; text-align:right;">
                ...
                <span style="font-size:16px;">$</span><span style="font-size:40px; color:;">
					<?=number_format(($tb_page_division->obtenerDato("taxes","division_id=$division_id")*($tb_page_dedicated_package->obtenerDato("monthly_price","domain_id='".$domain_id_instant."'AND type='VPSWIN' Order by monthly_price ASC"))),2);?>
                </span>
                ...
                <div style="width:205px; margin-left:15px; height:35px;float:left;margin-top:3px;">
                  	<input name="packnametxt" id="packnametxt" type="text" disabled="disabled" style="width:195px; padding-top:2px;height:27px; border:none; background-color:#FFF; font-size:16px; padding-left:5px;" />
              			<div id="showpacks" style="width:202px; overflow:hidden; margin-left:2px; margin-top:4px;border:solid 1px #E7E7E7; border-top:none; border-bottom:solid 1px #F3F3F3;z-index:6; background-color:#FFF; position:relative; display:none;" >
                            ...
                            <? 
                                    $checked=true;
                                    $list_dedicated_package=$tb_page_dedicated_package->select("serie,processor,dedicated_ip,control_panel,memory,disk_space,bandwidth,monthly_price,link_tobuy","type='VPSWIN' AND domain_id='".$domain_id_instant."'");
                                    ...
                                    do{
										...
										if($page_seccion=="/"){
										?>
											<a href="<?=$country;?>/vps/windows/#details" style="color:#06C;padding-right:10px;">&#187; detalles</a>
										<? 
										}
                                        echo "</div>";
                                        if($checked){ ?>
