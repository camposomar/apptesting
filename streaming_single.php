...
<? 
$list_package=$tb_core_packages->select("package_id,name,price_monthly,price_quarterly,module,price_semiannual,price_yearly,price_2yearly,price_3yearly","company_id='$_SESSION[core_company_id]' AND type='shared' AND module='centovacast' Order by price_monthly ASC");
$row_package=mysql_fetch_assoc($list_package);
?>
<div style="overflow:hidden; ">
    
        <div style="color:#333; font-size:26px; font-weight:900px;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;text-shadow: 0 1px 0 #EAEAEA; margin-top:10px;">Streaming de audio - tu Radio en internet</div>
        <div style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:13px; color:#333;text-shadow: 0 1px 0 #F9F9F9; margin-top:15px; margin-bottom:25px; line-height:20px;"> Es muy fácil. Sólo requieres instalar un programa en tu computadora, hacer un sencilla configuración y con eso, estarás envíando audio a nuestros servidores y éstos a su vez, lo distribuirán a tus oyentes aprovechando las altas velocidades en la trasmisión en ancho de banda que tenemos en nuestro Centro de Datos. </div>
